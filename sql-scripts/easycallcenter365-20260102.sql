...
Source Server         : 192.168.67.228
Source Server Version : 80029
Source Host           : 192.168.67.228:3306
...
-- ----------------------------
INSERT INTO `cc_agent_online` VALUES ('2601011745290110001', '1001', 'admin', '1', '5a3331fffe32af4b-00247d88-00000010-299095b913f23ef6-3a99fdd4', '3', '0', '1767260729084', '/192.168.67.217:60052', '0', '9', '1767260729137');
...
CREATE TABLE `cc_cust_dialog_asr` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='人工客服对话asr转写结果';
...
INSERT INTO `cc_ext_num` VALUES ('2', '1002', '0406f9d44bb8fe195a1ee2557bbeebf7', 'easycallcenter365');
...
CREATE TABLE `cc_gateways` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='外呼主叫号码表; ';

-- ----------------------------
-- Records of cc_gateways
-- ----------------------------
INSERT INTO `cc_gateways` VALUES ('1', 'outbound', 'external', '007', '', '192.168.67.217:58257', 'pcma', '软电话外呼测试', '1', '', '', '1', '1767239558630', '0', '{}', '2');
INSERT INTO `cc_gateways` VALUES ('2', 'test', 'external', '007', '', '192.168.67.217:50722', 'pcma', 'test', '2', '', '', '1', '1764661544408', '0', '{}', '3');
...
CREATE TABLE `cc_inbound_cdr` (
  ...
  `total_cost` decimal(10,8) NOT NULL DEFAULT '0.00000000' COMMENT '总调用费用（asr+tts+大模型）',
  `billing_status` int NOT NULL DEFAULT '0' COMMENT '计费状态（1：已计费、0：未计费）',
  `ivr_dtmf_digits` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'customer dtmf input digits',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- ----------------------------
INSERT INTO `cc_inbound_llm_account` VALUES ('1', '1', '1234567', 'aixia', 'aliyun_tts', 'ai', 'aliyun', 'acd', '1');
...
CREATE TABLE `cc_ivr` (
  ...
  `parent_node_id` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT 'id of parent node. ',
  `tts_text` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'The path of the audio file, or the speech-to-text',
  `action` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'acd、extension、hangup、gateway、play、playAndGetDigits、upaction、 function',
  `ai_transfer_data` varchar(255) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Data of specific manual transfer methods',
  ...
  `press_key_invalid_tips` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'invalid text tips or wav path.',
  ...
  `hangup_tips` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT 'hangup tips at current node.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Records of cc_ivr
-- ----------------------------
INSERT INTO `cc_ivr` VALUES ('1', '1', '-1', '测试IVR', '0', '售前咨询请按3，售后咨询请按2，身份证校验请按键4，重听请按键*号键，返回上一级请按键#号键。', 'play', '{\"destNumber\":\"111\",\"gatewayId\":\"1\"}', '7', '3', '输入错误，请重新输入', 'hangup', '^[1243]$', '1', 'aliyun_tts', 'abin', '1', '1', null, '');
INSERT INTO `cc_ivr` VALUES ('2', '1', '3', '售前服务', '1', '企业服务请按1，个人服务请按2', 'play', '', '5', '3', '输入错误，请重新输入', 'hangup', '^[0-9]+$', '1', 'doubao_tts', '', '1', '1', null, '');
...
INSERT INTO `cc_ivr` VALUES ('251224101457010001', '251224101457010001', '-1', '测试2', '0', '/home/Records/251224101457010001/20251231171950842146.wav', 'play', '', '5', '3', '输入错误，请重新输入。', 'upaction', '^[12]$', '1', 'aliyun_tts', 'aixia', '1', '1', null, '');
INSERT INTO `cc_ivr` VALUES ('251224101548010001', '251224101457010001', '1', '未还款原因调查', '251224101457010001', '/home/Records/251224101457010001/20251231172020733484.wav', 'play', '', '5', '3', '输入错误，请重新输入。', 'hangup', '^[123]$', '1', null, null, '1', '1', null, '感谢您的接听，祝您生活愉快，再见。');
...
INSERT INTO `cc_ivr` VALUES ('6', '1', '1', '订单查询', '5', '请输入订单号后5位', 'function', '', '5', '3', '', null, null, '1', '', '', '1', '1', null, '');
...
CREATE TABLE `cc_llm_kb` (
  `id` int NOT NULL,
  `cat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '知识类别',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '答案'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `cc_outbound_cdr` (
  ...
  `uuid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '通话uuid',
  `call_type` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'audio' COMMENT '通话类型; audio or  video',
  `time_len` int NOT NULL COMMENT '通话时长的秒数',
  `time_len_valid` int NOT NULL COMMENT '通话时长; 被叫接通后起计算; 毫秒数',
  `record_filename` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '录音文件名称',
  `hangup_cause` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '挂机原因',
  PRIMARY KEY (`id`)
...
INSERT INTO `cc_params` VALUES ('93', '是否开启二次打断设置(首次讲话不立即响应，等待客户第二次说话)', 'wait-for-second-vad-during-interrupt', 'false', 'sys', '0');
INSERT INTO `cc_params` VALUES ('94', '外呼时携带的额外变量参数(用户控制呼叫行为及设置特性等)', 'outbound-call-extra-params-for-profile-internal', 'sip_sticky_contact=true', 'sys', '0');
...
INSERT INTO `cc_params` VALUES ('19', '是否启动双向asr语音识别并推送结果', 'fs_call_asr_enabled', 'true', 'sys', '0');
INSERT INTO `cc_params` VALUES ('20', '双向asr语音识别，使用哪个asr引擎(chinatelecom/funasr/aliyun)', 'fs_call_asr_engine', 'chinatelecom', 'sys', '0');
INSERT INTO `cc_params` VALUES ('21', '是否启用呼入电话排队监控', 'inbound_call_monitor_enabled', 'true', 'sys', '0');
INSERT INTO `cc_params` VALUES ('22', 'Freeswitch的docker容器名称', 'fs_docker_container_name', 'freeswitch-debian12', 'sys', '0');
INSERT INTO `cc_params` VALUES ('23', 'Freeswitch配置文件路径', 'fs_conf_directory', '/home/freeswitch/etc/freeswitch', 'sys', '0');
INSERT INTO `cc_params` VALUES ('27', '语音识别类型; mrcp、websocket', 'robot-asr-type', 'websocket', 'sys', '0');
INSERT INTO `cc_params` VALUES ('29', 'mrcp 语音识别请求参数', 'fs-asr-mrcp-param', 'unimrcp:aliyun hello hello', 'sys', '0');
INSERT INTO `cc_params` VALUES ('30', '机器人通话中，最大客户静默时长; 客户超时不讲话通话会被自动掐断', 'robot-max-no-speak-time', '180', 'sys', '0');
INSERT INTO `cc_params` VALUES ('31', '呼入通话最大并发数限制', 'max-call-concurrency', '100', 'sys', '0');
INSERT INTO `cc_params` VALUES ('32', 'asr按需识别，仅在机器话术播报完毕后才启动', 'asr-pause-enabled', 'false', 'sys', '0');
INSERT INTO `cc_params` VALUES ('33', '检测到客户说话开始后，等待说话结束的最大时长;秒', 'max-wait-time-after-vad-start', '25', 'sys', '0');
INSERT INTO `cc_params` VALUES ('35', '呼入电话转接坐席超时时间; 秒', 'inbound-transfer-agent-timeout', '30', 'sys', '0');
INSERT INTO `cc_params` VALUES ('36', '转接到坐席时，隐藏呼入号码', 'hide-inbound-number', 'true', 'sys', '0');
INSERT INTO `cc_params` VALUES ('37', '转接到坐席时，是否播报工号', 'inbound-play-opnum', 'true', 'sys', '0');
INSERT INTO `cc_params` VALUES ('38', 'event socket ip address', 'event-socket-ip', '127.0.0.1', 'sys', '0');
INSERT INTO `cc_params` VALUES ('39', 'event socket port', 'event-socket-port', '8021', 'sys', '0');
INSERT INTO `cc_params` VALUES ('40', 'event socket password', 'event-socket-pass', 'ClueCon', 'sys', '0');
INSERT INTO `cc_params` VALUES ('41', 'event socket connection pool size', 'event-socket-conn-pool-size', '10', 'sys', '0');
INSERT INTO `cc_params` VALUES ('42', '最大坐席人数', 'max-agent-number', '100', 'sys', '0');
INSERT INTO `cc_params` VALUES ('43', '解密并验证token的Key', 'ws-server-auth-token-secret', 'TeleRobot2048AbDfF@#!', 'sys', '1');
INSERT INTO `cc_params` VALUES ('44', '(websocket server) 电话工具条端口', 'ws-server-port', '1081', 'sys', '0');
INSERT INTO `cc_params` VALUES ('45', '是否开启vad智能等待', 'vad-intelligent-wait', 'false', 'sys', '0');
INSERT INTO `cc_params` VALUES ('46', 'vad智能等待的毫秒数', 'vad-intelligent-wait-ms', '600', 'sys', '0');
INSERT INTO `cc_params` VALUES ('62', '呼叫中心WebAPI的 server-port (只读)', 'call-center-server-port', '8880', 'sys', '0');
INSERT INTO `cc_params` VALUES ('63', 'FreeSWITCH 部署方式; docker/native', 'fs-deploy-type', 'docker', 'sys', '0');
INSERT INTO `cc_params` VALUES ('64', 'FreeSWITCH native部署方式的启动脚本路径', 'fs-deploy-native-start-up-script', '/usr/local/freeswitchvideo/bin/freeswitch_start.sh', 'sys', '0');
INSERT INTO `cc_params` VALUES ('65', 'FreeSWITCH 程序根目录', 'fs-root-directory', '/usr/local/freeswitchvideo/', 'sys', '0');
INSERT INTO `cc_params` VALUES ('66', '服务器对外暴露的IP地址', 'call-center-server-ip-addr', '192.168.1.210', 'sys', '0');
INSERT INTO `cc_params` VALUES ('67', '呼叫中心电话工具条端口', 'call-center-websocket-port', '1081', 'sys', '0');
INSERT INTO `cc_params` VALUES ('96', '话术中涉及到的变量', 'tts_content_variables', '{\"custName\":\"姓名\", \"custAddress\":\"地址\", \"age\":\"年龄\", \"idTail\":\"身份证后四位\"}', 'sys', '0');
INSERT INTO `cc_params` VALUES ('69', '语音通知的访问Token', 'call-center-api-token', 'sk-35ae192********************', 'sys', '0');
INSERT INTO `cc_params` VALUES ('74', '全局参数; 可用的最大外呼并发数', 'outbound-max-line-number', '1000', 'batchcall', '0');
INSERT INTO `cc_params` VALUES ('78', '群呼转人工坐席的场景下，是否开启预测外呼算法', 'outbound-enable-prediction-algorithm', 'false', 'batchcall', '0');
INSERT INTO `cc_params` VALUES ('79', '阿里云tts账号参数json', 'aliyun-tts-account-json', '{\"access_key_id\":\"LTAI5xxxxxxxL591e\",\"cluster\":\"volcano_tts\",\"write_pcm_enable\":\"0\",\"voice_name\":\"aixia\",\"language\":\"1\",\"server_url_webapi\":\"https://nls-gateway.aliyuncs.com/stream/v1/tts\",\"app_key\":\"fnFiu4G4nJ3RRKTO\",\"sample_rate\":\"16000\",\"voice_volume\":\"50\",\"ws_conn_timeout_ms\":\"9000\",\"access_key_secret\":\"238XOSSxxxxxxxSGcuBsT\",\"speech_rate\":\"-100\",\"server_url\":\"wss://nls-gateway.aliyuncs.com/ws/v1\"}', 'tts', '1');
INSERT INTO `cc_params` VALUES ('80', '空号识别功能是否开启', 'empty-number-detection-enabled', 'false', 'batchcall', '0');
...
INSERT INTO `cc_params` VALUES ('82', '打断忽略关键字列表默认值', 'default_interrupt_ignore_keywords', '呃 哦 哦哦 嗯 嗯嗯 嗯好的 好的 对 对对 是的 明白 啊 这样啊 是这样啊这样的 您好 你好', 'sys', '0');
INSERT INTO `cc_params` VALUES ('83', '连接大模型的最大尝试次数', 'llm-max-try', '2', 'sys', '0');
INSERT INTO `cc_params` VALUES ('84', '连接大模型的超时时间; 毫秒', 'llm-conn-timeout', '3500', 'sys', '0');
INSERT INTO `cc_params` VALUES ('85', '连接大模型的失败提示语', 'llm-max-try-fail-tips', '抱歉刚才信号不好，我没有听清楚，您能在说一遍吗?', 'sys', '0');
INSERT INTO `cc_params` VALUES ('86', '允许访问接口的ip白名单', 'api-client-white-ips', '127.0.0.1,192.168.66.164,192.168.67.217', 'sys', '0');
INSERT INTO `cc_params` VALUES ('88', '阿里云asr单价（每小时）', 'price_aliyun_asr', '1.8', 'sys', '0');
INSERT INTO `cc_params` VALUES ('89', '阿里云tts单价（每千次）', 'price_aliyun_tts', '1.8', 'sys', '0');
INSERT INTO `cc_params` VALUES ('90', '阿里云声音克隆单价（每万字符）', 'price_aliyun_tts_flow', '2.0', 'sys', '0');
INSERT INTO `cc_params` VALUES ('91', '大模型单价（每千token）', 'price_llm_token', '0.00015', 'sys', '0');
INSERT INTO `cc_params` VALUES ('92', '豆包tts账号参数json', 'doubao-tts-account-json', '{\"access_token\":\"esgS1pvxxxxxxxxxGPVTY7j\",\"cluster\":\"volcano_tts\",\"emotion\":\"happy\",\"sample_rate\":\"16000\",\"write_pcm_enable\":\"0\",\"ws_conn_timeout_ms\":\"9000\",\"speech_rate\":\"1\",\"voice_name\":\"S_T7d3irgK1\",\"language\":\"0\",\"server_url\":\"wss://openspeech.bytedance.com/api/v1/tts/ws_binary\",\"server_url_webapi\":\"https://openspeech.bytedance.com/api/v1/tts\",\"app_id\":\"8380189306\"}', 'tts', '1');
...
CREATE TABLE `cc_tts_aliyun` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=546 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='阿里云音色列表';
...
INSERT INTO `sys_config` VALUES ('12', '系统版本号', 'sys.version', 'v20260103', 'Y', 'admin', '2025-08-04 05:57:40', '', null, '系统版本号（每次版本升级需要更新该值）');
...
) ENGINE=InnoDB AUTO_INCREMENT=365 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3077 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('2030', '日志监控', 'catLogs', '2000', '9', '/cc/fsconf/catlogs', 'menuItem', 'C', '1', '1', 'cc:catlogs:view', '#', 'admin', '2024-12-22 19:31:11', 'admin', '2025-07-27 13:06:53', '');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', 'admin', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/07/12/blob_20250712095449A001.png', 'bb9996e4c3fca145d80391541336cf8f', 'ec17b5', '0', '0', '192.168.67.217', '2026-01-01 17:45:27', '2025-09-23 10:50:50', 'admin', '2024-12-11 02:42:33', '', '2026-01-01 09:45:27', '管理员', null);
INSERT INTO `sys_user` VALUES ('3', '103', 'easycallcenter365', 'easycallcenter365', '00', '492322852@qq.com', '15005600327', '0', '', '7b3a7db13d2677bccecedf83d7d58f7f', 'b971a4', '0', '0', '112.122.28.217', '2025-08-16 19:40:45', '2025-08-14 17:19:05', 'admin', '2025-05-05 12:58:06', '', '2025-08-16 11:40:45', null, null);
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('9276cae9-5a44-43e1-8e10-c9b205df342f', 'admin', '研发部门', '192.168.67.217', '内网IP', 'Chrome 14', 'Windows 10', 'on_line', '2026-01-01 17:45:24', '2026-01-01 18:00:19', '1800000');
