...
-- ----------------------------
INSERT INTO `cc_agent_online` VALUES ('2508162347380110001', '1001', 'admin', '1', '000c29fffe11e5c2-00000b38-0000000c-31fc4a146fa3d365-ed0cd655', '3', '0', '1755402458053', '/192.168.14.210:57061', '0', '9', '1755402458173');
INSERT INTO `cc_agent_online` VALUES ('2508162353100110001', '1001-inboundMonitor', 'admin-inboundMonitor', '0', '000c29fffe11e5c2-00000b38-0000000d-4bd34641a1a8e630-f51eba29', '3', '0', '1755402790456', '/192.168.14.210:57338', '0', '9', '1755402790463');
INSERT INTO `cc_agent_online` VALUES ('2508162353100110002', '1001-agentMonitor', 'admin-agentMonitor', '0', '000c29fffe11e5c2-00000b38-0000000e-94c163a5a1a8e850-13444123', '3', '0', '1755402790996', '/192.168.14.210:57339', '0', '9', '1755402791002');
...
CREATE TABLE `cc_cust_call_record` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `uuid` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '通话id',
...
CREATE TABLE `cc_gateways` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='外呼主叫号码表; ';
...
CREATE TABLE `cc_llm_agent_account` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Conversation foundation:  configuration parameters for accessing large language models or ai agents.';
...
INSERT INTO `cc_params` VALUES ('63', 'FreeSWITCH native部署方式的启动脚本路径', 'fs-deploy-native-start-up-script', '/usr/local/freeswitchvideo/bin/freeswitch_start.sh', 'sys', '0');
...
INSERT INTO `cc_params` VALUES ('78', '阿里云tts账号参数json', 'aliyun-tts-account-json', '{\"access_key_id\":\"LTA**********************xuR\",\"app_key\":\"nbf********************4Wr\",\"sample_rate\":\"16000\",\"voice_volume\":\"50\",\"write_pcm_enable\":\"0\",\"ws_conn_timeout_ms\":\"9000\",\"access_key_secret\":\"auO*******************xEU\",\"speech_rate\":\"-100\",\"voice_name\":\"aixia\",\"server_url\":\"ws://nls-gateway.aliyuncs.com:80/ws/v1\",\"server_url_webapi\":\"https://nls-gateway.aliyuncs.com/stream/v1/tts\"}', 'tts', '1');
...
INSERT INTO `fs_variables` VALUES ('37', '5', 'speech_rate', '语速，取值范围：-500～500，默认值：0');
...
INSERT INTO `sys_config` VALUES ('12', '系统版本号', 'sys.version', 'v20250817', 'Y', 'admin', '2025-08-04 05:57:40', '', null, '系统版本号（每次版本升级需要更新该值）');
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('15', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-07 00:43:18');
INSERT INTO `sys_logininfor` VALUES ('16', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-07 05:41:29');
INSERT INTO `sys_logininfor` VALUES ('17', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-07 06:20:18');
INSERT INTO `sys_logininfor` VALUES ('18', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-07 06:59:46');
INSERT INTO `sys_logininfor` VALUES ('19', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-17 03:20:46');
INSERT INTO `sys_logininfor` VALUES ('20', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-17 03:40:57');
INSERT INTO `sys_logininfor` VALUES ('21', 'admin', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-08-17 03:47:36');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3067 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('110', '定时任务', 'jobManage', '2', '2', '/monitor/job', '', 'C', '0', '1', 'monitor:job:view', 'fa fa-tasks', 'admin', '2024-12-11 02:42:46', '', null, '定时任务菜单');
INSERT INTO `sys_menu` VALUES ('111', '数据监控', 'dataMonitor', '2', '3', '/monitor/data', '', 'C', '0', '1', 'monitor:data:view', 'fa fa-bug', 'admin', '2024-12-11 02:42:46', '', null, '数据监控菜单');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', 'admin', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/07/12/blob_20250712095449A001.png', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '192.168.14.210', '2025-08-17 11:47:36', null, 'admin', '2024-12-11 02:42:33', '', '2025-08-17 03:47:35', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('5dae7994-4d37-4526-bc7a-38304143d8ce', 'admin', '研发部门', '192.168.14.210', '内网IP', 'Chrome 13', 'Windows 10', 'on_line', '2025-08-17 11:20:37', '2025-08-17 11:58:14', '1800000');
